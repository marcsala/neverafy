      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Disponible para iOS y Android. Empieza a ahorrar desde el primer día.
          </p>
          
          <div className="mb-8">
            <p className="text-sm text-gray-500 mb-4">Disponible en</p>
            <div className="flex justify-center space-x-4">
              <a href="#" className="bg-black text-white px-6 py-3 rounded-lg flex items-center space-x-2 hover:bg-gray-800 transition-colors">
              ...
              <a href="#" className="bg-black text-white px-6 py-3 rounded-lg flex items-center space-x-2 hover:bg-gray-800 transition-colors">
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M3,20.5V3.5C3,2.91 3.34,2.39 3.84,2.15L13.69,12L3.84,21.85C3.34,21.61 3,21.09 3,20.5M16.81,15.12L6.05,21.34L14.54,12.85L16.81,15.12M20.16,10.85C20.5,11.13 20.75,11.56 20.75,12C20.75,12.44 20.5,12.87 20.16,13.15L17.89,14.5L15.39,12L17.89,9.5L20.16,10.85M6.05,2.66L16.81,8.88L14.54,11.15L6.05,2.66Z"/>
                </svg>
